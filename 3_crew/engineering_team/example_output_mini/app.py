...
with gr.Blocks() as app:
    ...
    with gr.Group():
        ...
        deposit_button.click(
            deposit_funds, inputs=deposit_input, outputs=deposit_output
        )
    ...
    with gr.Group():
        ...
        withdraw_button.click(
            withdraw_funds, inputs=withdraw_input, outputs=withdraw_output
        )
    ...
    with gr.Group():
        ...
        portfolio_value_button.click(
            total_portfolio_value, outputs=portfolio_value_output
        )
